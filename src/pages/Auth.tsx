  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-slate-900 to-indigo-950 p-4">
      ...
      >
        ...
        >
          <Card className="bg-card/50 backdrop-blur-sm border-border hover-lift">
            <CardHeader>
              <CardTitle>Welcome</CardTitle>
              <CardDescription>
                Sign in to your account or create a new one to start booking railway freight services
              </CardDescription>
            </CardHeader>
            <CardContent>
